...
from engine.base.handlers import PortfolioServer
...
class BrokerApp(EWrapper, EClient):
    ...
    def connectAck(self):
        super().connectAck()
        self.portfolio_logger.info('Established Connection')
        self.connected_event.set()

    #### wrapper function for disconnect() -> Signals disconnection.
    def connectionClosed(self):
        super().connectionClosed()
        self.portfolio_logger.info('Closed Connection.')
    ...
    def nextValidId(self, orderId):
        ...
        self.portfolio_logger.info(f"next_valid_id {self.next_valid_order_id}")
    ...
    def updateAccountValue(self, key:str, val:str, currency:str,accountName:str):
        ...
        self.portfolio_logger.info(f"Received account information for account {accountName}")
    ...
    def updatePortfolio(self, contract, position, marketPrice, marketValue, averageCost, unrealizedPNL, realizedPNL, accountName):
        ...
        # Update PortfolioServer with the new position data
        self.portfolio_server.update_positions(contract.symbol, position_data)

        self.portfolio_logger.info(f"Received position information for account {accountName}")
    ...
    def openOrder(self, orderId, contract, order, orderState):
        ...
        self._update_active_orders(data)
