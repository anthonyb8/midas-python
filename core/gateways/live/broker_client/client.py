...
class BrokerClient():
    ...
    def __init__(self, event_queue: Queue, logger:logging.Logger,portfolio_server: PortfolioServer, host=api_config['HOST'], port=api_config['PORT'], clientId=api_config['TRADE_CLIENT_ID'], ib_account =api_config['IB_ACCOUNT']):
        self.logger = logger
