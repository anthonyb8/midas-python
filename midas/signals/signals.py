...
class TradeInstruction:
    def __init__(self, ticker:str, order_type: OrderType, action: Action, trade_id: int, leg_id: int, weight: float):
        self._data_validation(ticker, order_type,action, trade_id, leg_id, weight)
    ...
    def _data_validation(self, ticker: str,order_type, action: Action, trade_id: int, leg_id: int, weight: float):
